...
RETRY_PARAMS_DOCSTRING = """
    ...
    :param exceptions: exceptions classes that will trigger another
        ...
        can be eiher an :py:class:`Exception` or a :py:class:`tuple`
        of :py:class:`Exception` (actually, whatever is suitable for
        an except clause). The default is the :py:class:`Exception`
